...
const PolicyManager: React.FC = () => {
    ...
    const downloadTemplate = () => {
        ...
        const ws1 = XLSX.utils.json_to_sheet([
            { '지역명': '서울', '관할법원': '서울회생법원', '지역그룹': 'Seoul' },
            { '지역명': '용인', '관할법원': '수원회생법원', '지역그룹': 'Overcrowded' },
            { '지역명': '부산', '관할법원': '부산회생법원', '지역그룹': 'Metro' },
        ]);
        const ws2 = XLSX.utils.json_to_sheet([
            { '지역그룹': 'Seoul', '보증금상한': 170000000, '공제금액': 57000000 },
            { '지역그룹': 'Overcrowded', '보증금상한': 150000000, '공제금액': 50000000 },
            { '지역그룹': 'Metro', '보증금상한': 88000000, '공제금액': 29000000 },
            { '지역그룹': 'Others', '보증금상한': 78000000, '공제금액': 26000000 },
        ]);
